...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::prefix('admin/users')->group(function () {
        ...
        Route::get('{user_id}', [UserManagementController::class, 'edit'])->name('admin.users.edit');
        Route::put('{user_id}', [UserManagementController::class, 'update'])->name('admin.users.update');
